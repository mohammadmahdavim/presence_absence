...
class MangerImporter implements ToCollection, WithHeadingRow
{
    /**
        ...
        foreach ($collection as $row) {
            if (!in_array($row['code'], $codes)) {
                ...
                $id=Personnel::create([
                    ...
                    'is_full_time' => $row['is_full_time'] == 1 ? 1 : 0
                ])->id;
    ...
    public function loge($name, $manager)
    {
